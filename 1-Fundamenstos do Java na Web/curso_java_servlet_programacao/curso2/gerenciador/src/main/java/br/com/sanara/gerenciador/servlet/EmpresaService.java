...
public class EmpresaService extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * 
		 * // devolvendo um xml /*XStream xstream = new XStream();
		 * xstream.alias("empresa", Empresa.class); String xml =
		 * xstream.toXML(empresas);
		 * 
		 * response.setContentType("application/xml"); response.getWriter().print(xml);
		 */
